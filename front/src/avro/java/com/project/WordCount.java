...
public class WordCount extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -5953692740222199704L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"WordCount\",\"namespace\":\"com.project\",\"fields\":[{\"name\":\"url\",\"type\":{\"type\":\"array\",\"items\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}}]}");
   ...
   */
  public static BinaryMessageEncoder<WordCount> getEncoder() {
    return ENCODER;
  }
   ...
   * @return a WordCount instance decoded from the given buffer
   ...
   */
  public WordCount(java.util.List<java.lang.String> url) {
    this.url = url;
  }
   ...
   */
  public static com.project.WordCount.Builder newBuilder() {
    return new com.project.WordCount.Builder();
  }
   ...
   * @return A new WordCount RecordBuilder
   */
  public static com.project.WordCount.Builder newBuilder(com.project.WordCount.Builder other) {
    if (other == null) {
      return new com.project.WordCount.Builder();
    } else {
      return new com.project.WordCount.Builder(other);
    }
  }
   ...
   * @return A new WordCount RecordBuilder
   */
  public static com.project.WordCount.Builder newBuilder(com.project.WordCount other) {
    if (other == null) {
      return new com.project.WordCount.Builder();
    } else {
      return new com.project.WordCount.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<WordCount>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.project.WordCount.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.project.WordCount other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.url)) {
        this.url = data().deepCopy(fields()[0].schema(), other.url);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.project.WordCount.Builder setUrl(java.util.List<java.lang.String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.project.WordCount.Builder clearUrl() {
      url = null;
